...
/// A peer authorized via TGP TripleProof (6-packet bilateral construction).
///
...
/// bilateral TripleProofs that serve as permanent authorization.
///
/// Benefits over TCP connection state:
/// - **No phantom peers**: A peer exists iff TripleProof exists
...
/// - **No half-open state**: TripleProof is bilateral—both have it or neither does
#[derive(Debug, Clone)]
...
impl AuthorizedPeer {
    /// Create a new authorized peer from bilateral TripleProofs.
    ///
